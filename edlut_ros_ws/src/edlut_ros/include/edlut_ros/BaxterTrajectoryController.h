...
#ifndef BAXTERTRAJECTORYCONTROLLER_H_
#define BAXTERTRAJECTORYCONTROLLER_H_
 ...
 */
class BaxterTrajectoryController {
...
public:
	 ...
	 */
	BaxterTrajectoryController(std::vector<std::string> joint_list,
	 ...
	 */
	virtual ~BaxterTrajectoryController();

};

#endif /* BAXTERTRAJECTORYCONTROLLER_H_ */
