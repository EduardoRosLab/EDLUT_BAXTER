/***************************************************************************
 *                     q_trajectory_generator_node_random.cpp  	           *
 *                           -------------------                           *
...
int main(int argc, char **argv)
{
	...
	int number_of_trials, samples, columns, number_of_tasks;
	bool use_sim_time;
	...
	private_node_handle_.getParam("number_of_tasks", number_of_tasks);
	...
	ROS_INFO("Q_RANDOOOOOOOOOM 1111111111111111");
	// Create the Sinusoidal Trajectory Generator
	Q_TrajectoryGeneratorRandom TrajGenerator (use_sim_time, max_pos_amplitude, min_pos_amplitude, max_vel_amplitude,
		min_vel_amplitude, samples, positions_file_name, velocities_file_name, trajectory_frequency, number_of_tasks);
	ROS_INFO("Q_RANDOOOOOOOOOM 22222222222222222");
	// Create the trajectory controller
	Q_TrajectoryControllerRandom TrajController(joint_list,
