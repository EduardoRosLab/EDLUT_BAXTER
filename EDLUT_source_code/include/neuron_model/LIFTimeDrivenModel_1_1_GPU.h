...
#ifndef LIFTIMEDRIVENMODEL_1_1_GPU_H_
#define LIFTIMEDRIVENMODEL_1_1_GPU_H_

/*!
 * \file LIFTimeDrivenModel_1_1_GPU.h
 *
...
class LIFTimeDrivenModel_1_1_GPU2;
 ...
 * one excitatory conductance. This model is implemented in CPU to control a GPU class.
 *
 ...
 * \date December 2018
 */
class LIFTimeDrivenModel_1_1_GPU : public TimeDrivenNeuronModel_GPU {
	protected:
		/*!
		...
		*/
		LIFTimeDrivenModel_1_1_GPU2 ** NeuronModel_GPU2;
	...
	public:
		...
		*/
		 ...
		 */
		LIFTimeDrivenModel_1_1_GPU(string NeuronTypeID, string NeuronModelID);
		 ...
		 */
		virtual ~LIFTimeDrivenModel_1_1_GPU();
...
#endif /* LIFTIMEDRIVENMODEL_1_1_GPU_H_ */
