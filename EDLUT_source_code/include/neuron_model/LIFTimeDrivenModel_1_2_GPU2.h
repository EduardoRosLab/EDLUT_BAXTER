		...
		*/
		__device__ void loadIntegrationMethod_GPU2(char const* integrationName, void ** Buffer_GPU){
			...
			if (cmp4(integrationName, "Euler", 5) == 0){
				this->integrationMethod_GPU2 = (Euler_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new Euler_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else if (cmp4(integrationName, "RK2", 3) == 0){
				this->integrationMethod_GPU2 = (RK2_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new RK2_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else if (cmp4(integrationName, "RK4", 3) == 0){
				this->integrationMethod_GPU2 = (RK4_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new RK4_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else if (cmp4(integrationName, "BDF", 3) == 0 && atoiGPU(integrationName, 3)>0 && atoiGPU(integrationName, 3)<7){
				this->integrationMethod_GPU2 = (BDFn_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new BDFn_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU, atoiGPU(integrationName, 3));
			}
			else if (cmp4(integrationName, "Bifixed_Euler", 13) == 0){
				this->integrationMethod_GPU2 = (Bifixed_Euler_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new Bifixed_Euler_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else if (cmp4(integrationName, "Bifixed_RK2", 11) == 0){
				this->integrationMethod_GPU2 = (Bifixed_RK2_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new Bifixed_RK2_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else if (cmp4(integrationName, "Bifixed_RK4", 11) == 0){
				this->integrationMethod_GPU2 = (Bifixed_RK4_GPU2<LIFTimeDrivenModel_1_2_GPU2> *) new Bifixed_RK4_GPU2<LIFTimeDrivenModel_1_2_GPU2>(this, Buffer_GPU);
			}
			else{
