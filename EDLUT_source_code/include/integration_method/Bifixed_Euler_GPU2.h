...
/*!
 * \file Bifixed_Euler_GPU2.h
 *
 * \author Francisco Naveros
 * \date May 2015
 *
 * This file declares a class which implement a multi stpe Euler integration method in GPU (this class is stored
...
class Bifixed_Euler_GPU2 : public BiFixedStep_GPU2 {
	public:
		...
		*/
		__device__ Bifixed_Euler_GPU2(Neuron_Model_GPU2* NewModel, void ** Buffer_GPU) :BiFixedStep_GPU2(Buffer_GPU, NewModel->timeScale), neuron_model(NewModel){
		...
		__device__ void NextDifferentialEquationValues(int index, int SizeStates, float * NeuronState){
			for(int iteration=0; iteration<N_BiFixedSteps; iteration++){
				...
				neuron_model->EvaluateDifferentialEquation(index, SizeStates, NeuronState, AuxNeuronState, this->bifixedElapsedTimeInNeuronModelScale);
