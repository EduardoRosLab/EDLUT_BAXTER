...
#ifndef Bifixed_RK2_GPU_H_
#define Bifixed_RK2_GPU_H_

/*!
 * \file Bifixed_RK2_GPU.h
 *
...
class Bifixed_RK2_GPU: public BiFixedStep_GPU{
	public:
		...
		*/
		 ...
		 */
		Bifixed_RK2_GPU(TimeDrivenNeuronModel_GPU * NewModel, int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState);
