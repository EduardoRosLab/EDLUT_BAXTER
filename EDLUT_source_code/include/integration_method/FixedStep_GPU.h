...
#ifndef FIXEDSTEP_GPU_H_
#define FIXEDSTEP_GPU_H_

/*!
 * \file FixedStep_GPU.h
 *
 ...
 * \date May 2015
 */
class FixedStep_GPU : public IntegrationMethod_GPU  {
	public:
		 ...
		 */
		FixedStep_GPU(TimeDrivenNeuronModel_GPU * NewModel, char * integrationMethodType, int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState);
