...
void LIFTimeDrivenModel_1_4_GPU::LoadNeuronModel(string ConfigFile) throw (EDLUTFileException){
	...
	if(fh){
											...
											if (fscanf(fh, "%f", &this->tref) == 1 && this->tref > 0.0f){
												...
												if (fscanf(fh, "%f", &this->grest) == 1 && this->grest > 0.0f){
													...
													if(fscanf(fh,"%f",&this->fgj)==1){
														...
														throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_FGJ, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
													}
												}else {
													throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_GREST, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
												}
											}else {
												throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_TREF, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
											}
										}else {
											throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_GAP, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
										}
									}else {
										throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_TINH, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
									}
								}else {
									throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_TNMDA, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
								}
							}else {
								throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_TAMPA, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
							}
						}else {
							throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_CM, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
						}
					}else {
						throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_VTHR, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
					}
				}else {
					throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_EREST, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
				}
			}else {
				throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_EINH, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
			}
		}else {
			throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_LIF_TIME_DRIVEN_MODEL_1_4_EEXC, REPAIR_NEURON_MODEL_VALUES, Currentline, ConfigFile.c_str(), true);
		}
		...
		throw EDLUTFileException(TASK_LIF_TIME_DRIVEN_MODEL_1_4_GPU_LOAD, ERROR_NEURON_MODEL_OPEN, REPAIR_NEURON_MODEL_NAME, Currentline, ConfigFile.c_str(), true);
	}
	fclose(fh);
}

LIFTimeDrivenModel_1_4_GPU::LIFTimeDrivenModel_1_4_GPU(string NeuronTypeID, string NeuronModelID): TimeDrivenNeuronModel_GPU(NeuronTypeID, NeuronModelID, SecondScale), eexc(0), einh(0), erest(0), vthr(0), cm(0), tampa(0), tnmda(0), tinh(0), tgj(0),
		tref(0), grest(0){
}
...
InternalSpike * LIFTimeDrivenModel_1_4_GPU::ProcessInputSpike(Interconnection * inter, double time){
...
bool LIFTimeDrivenModel_1_4_GPU::UpdateState(int index, double CurrentTime){
...
enum NeuronModelOutputActivityType LIFTimeDrivenModel_1_4_GPU::GetModelOutputActivityType(){
	return OUTPUT_SPIKE;
}

enum NeuronModelInputActivityType LIFTimeDrivenModel_1_4_GPU::GetModelInputActivityType(){
	return INPUT_SPIKE;
}
...
__global__ void LIFTimeDrivenModel_1_4_GPU_InitializeClassGPU2(LIFTimeDrivenModel_1_4_GPU2 ** NeuronModel_GPU2, 
	...
	if(blockIdx.x==0 && threadIdx.x==0){
		(*NeuronModel_GPU2) = new LIFTimeDrivenModel_1_4_GPU2(eexc,einh,erest,vthr,cm,
...
void LIFTimeDrivenModel_1_4_GPU::InitializeClassGPU2(int N_neurons){
	...
	LIFTimeDrivenModel_1_4_GPU_InitializeClassGPU2<<<1,1>>>(NeuronModel_GPU2, eexc,einh,erest,vthr,cm,tampa,
...
bool LIFTimeDrivenModel_1_4_GPU::CheckSynapseType(Interconnection * connection){
