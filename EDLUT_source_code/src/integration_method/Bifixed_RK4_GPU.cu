...
#include "../../include/integration_method/Bifixed_RK4_GPU.h"
#include "../../include/integration_method/Bifixed_RK4_GPU2.h"
...
Bifixed_RK4_GPU::Bifixed_RK4_GPU(TimeDrivenNeuronModel_GPU * NewModel, int N_neuronStateVariables, int N_differentialNeuronState, int N_timeDependentNeuronState):BiFixedStep_GPU(NewModel, "Bifixed_RK4", N_neuronStateVariables, N_differentialNeuronState, N_timeDependentNeuronState){
}

Bifixed_RK4_GPU::~Bifixed_RK4_GPU(){
...
__global__ void Bifixed_RK4_GPU_position(void ** vector, float * integration_method_parameters_GPU, float * element1, float * element2, float * element3, float * element4, float * element5){
...
void Bifixed_RK4_GPU::InitializeMemoryGPU(int N_neurons, int Total_N_thread){
	...
	Bifixed_RK4_GPU_position<<<1,1>>>(Buffer_GPU, integration_method_parameters_GPU, AuxNeuronState, AuxNeuronState1, AuxNeuronState2, AuxNeuronState3, AuxNeuronState4);
